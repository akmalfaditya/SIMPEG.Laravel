...
<div class="bg-white rounded-2xl border border-slate-200 shadow-sm">
    <div class="p-5 border-b border-slate-100 flex flex-col sm:flex-row sm:items-center gap-3">
        <div class="flex items-center gap-2 flex-wrap">
            ...
            <a href="{{ route('kgb.ditunda') }}" class="px-3 py-1.5 text-xs rounded-lg {{ $filterTitle && str_contains($filterTitle, 'Ditunda') ? 'bg-red-600 text-white' : 'bg-red-50 text-red-600 hover:bg-red-100' }}">Ditunda (Hukdis)</a>
        </div>
        ...
        <table class="w-full text-sm" id="data-table">
            ...
            <tbody class="divide-y divide-slate-100" id="table-body">
                ...
                <td class="px-4 py-2.5 text-center">
                    ...
                    <a href="{{ route('kgb.process.form', $a['pegawai_id']) }}" class="inline-flex items-center px-3 py-1.5 text-xs font-medium bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition-colors">
