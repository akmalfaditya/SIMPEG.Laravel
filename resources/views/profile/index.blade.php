    ...
    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
        ...
        <form method="POST" action="{{ route('profile.password') }}">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="password" name="current_password" required
                        class="w-full px-3 py-2 border border-slate-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-400">
            ...
            <div class="flex gap-3 mt-6 pt-4 border-t border-slate-200">
                <button type="submit" class="px-6 py-2.5 bg-blue-600 text-white text-sm font-medium rounded-xl hover:bg-blue-700 transition-colors">Ubah Password</button>
            </div>
        </form>
    </div>
</div>
