...
class KenaikanPangkatController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('kenaikan-pangkat.index', ['candidates' => $candidates, 'filterTitle' => null]);
    }
    ...
    public function eligible()
    {
        ...
        return view('kenaikan-pangkat.index', ['candidates' => $eligible, 'filterTitle' => 'Pegawai Eligible Kenaikan Pangkat']);
    }
}
